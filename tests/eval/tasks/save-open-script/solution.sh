...
# The fixture plugin needs a moment after startup to fabricate the unsaved
# buffer; a model's first call is never this fast.
sleep 2

run save_script --file-path res://player.gd
